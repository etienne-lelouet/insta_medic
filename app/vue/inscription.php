                                    ...
                                    <form method="post" action="" enctype="multipart/form-data">
                                        <div class="form-row infoPerso">
                                            ...
                                            <div class="form-group nom formulaireContent">
                                                ...
                                                <input name="nom" class="form-control formulaire" id="inputNom">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group prenom formulaireContent">
                                                ...
                                                <input name="prenom" class="form-control formulaire" id="inputPrenom">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group dateDeNaissance formulaireContent">
                                                ...
                                                <input type="text" name="date_naissance" class="form-control formulaire" placeholder="JJ/MM/AAAA">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group adresse formulaireContent">
                                                ...
                                                <input name="adresse" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group adresse formulaireContent">
                                                ...
                                                <input name="adressecomp" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group codePostale formulaireContent">
                                                ...
                                                <input name="code_postal" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group ville formulaireContent">
                                                ...
                                                <input name="ville" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group telephone formulaireContent">
                                                ...
                                                <input name="telephone" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                        ...
                                        <div class="form-row infoCompte">
                                            ...
                                            <div class="form-group mail formulaireContent">
                                                ...
                                                <input name="login" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group mail formulaireContent">
                                                ...
                                                <input name="email" class="form-control formulaire " type="email">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <span></span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group motDePasse formulaireContent">
                                                ...
                                                <input type="password" name="password" class="form-control formulaire" type="password">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
                                            ...
                                            <div class="form-group motDePasse formulaireContent">
                                                ...
                                                <input type="password" name="pass2" class="form-control formulaire">
                                                <span>Veuillez entrer une valeur valide</span>
                                                <?php else: ?>
